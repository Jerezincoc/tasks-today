      ...
      <header className="mx-auto max-w-2xl bg-card/40 backdrop-blur-xl border border-white/5 shadow-2xl shadow-black/40 rounded-2xl overflow-hidden transition-all duration-300 hover:bg-card/50">
        <div className="px-5 py-3 flex items-center justify-between gap-3">
          <Link to="/" className="flex items-center gap-3">
            ...
            <span className="font-bold text-lg text-foreground tracking-tight hidden sm:block">Todo List</span>
          </Link>
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            <span className="text-sm font-medium text-muted-foreground truncate hidden md:inline max-w-[150px]">
              {email}
            </span>
            <Link to="/settings">
